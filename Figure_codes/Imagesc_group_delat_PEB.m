function Imagesc_group_delat_PEB(SPM_dir,Work_dir)
%%%%%%%%%%%%%%%%%
%GROUP_LEVEL PEB
%%%%%%%%%%%%%%%%%
load([Work_dir '/Results_paper_variability/DCM/Basic/Smith/Full_model/PEB_group/PEB_A_mean_group_delat_DMN.mat'],'PEB','DCM','PEB_group');
load([Work_dir '/DatasetKuehn/sub-01_summary/DCM/Basic/Smith/Full_model/GCM_DMN_full_estim.mat']);
DCM=GCM;

DCM{1}.xY(2).name='DCM_dIPC';
DCM{1}.xY(4).name='DCM_ndIPC';
...
saveas(gcf,[Work_dir '/Figures_paper_variability/Group_PEB_delat_Ep.bmp']);
close;
clear DCM PEB;
end